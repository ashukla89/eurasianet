...
var width = 400 - margin.left - margin.right; // And grabbing your container

var container = d3.select('#chart-08'); // Create your scales

xPositionScale = d3.scaleLinear().domain(['Extremely Cold', 'Cold', 'Normal', 'Hot', 'Extremely Hot']).range([0, width]);
yPositionScale = d3.scaleLinear().range([height, 0]);
colorScale = d3.scaleOrdinal().range(); // Create your area generator
// Read in your data, then call ready
// Write your ready function
},{"d3":"../node_modules/d3/index.js"}]},{},["scripts/chart-08.js"], null)
//# sourceMappingURL=/chart-08.ad8d4976.js.map