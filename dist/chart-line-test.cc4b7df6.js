...
var color = d3.scaleOrdinal().range(['blue', 'orange', 'green']);
...
var svg = d3.select("#chart-line-test").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")"); // Read in your data

d3.csv(require('../data/lines-test.csv')).then(ready).catch(function (err) {
  console.log(err);
...
},{"d3":"../node_modules/d3/index.js","../data/lines-test.csv":"data/lines-test.csv"}]},{},["scripts/chart-line-test.js"], null)
//# sourceMappingURL=/chart-line-test.cc4b7df6.js.map